...
class Display(Container):
    def __init__(self, page: Page):
        ...
        self.content = Column([Row([Text("Structures de donnee", text_align='center', expand=True, color=DEEP_BLUE, weight='bold', size=50)])], alignment=MainAxisAlignment.CENTER)